...
現在のすべての[未解決の問題](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered/issues)はGitHubで確認できます。

## <HopeIcon icon="iconfont icon-visual-studio" size="1.5rem" color="rgb(193,142,241)" /> Snap.Hutao プロジェクトの設定
より詳細な貢献情報については、GitHubの[CONTRIBUTING.md](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered?tab=contributing-ov-file#contribute-your-code)を参照してください。  
このガイドは必須ではありません。状況に応じて個人の習慣に合わせて調整できます。
1. [Visual Studio 2026](https://visualstudio.microsoft.com/downloads/)をダウンロードしてインストールします。
...
2. Gitを使用してプロジェクトリポジトリをクローンします：`git@github.com:SnapHutaoRemasteringProject/Snap.Hutao.Remastered.git`。
3. ブランチを `develop` に切り替えます。
4. Visual Studio を使用して、対応する .slnx ファイルでプロジェクトソリューションを開くと、開発を開始できます。
...
::: warning 注意事項
最新のアルファバージョンを試用したい場合は、まず[**SnapHutaoRemasteringProjectRootCA.cer**](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered/raw/refs/heads/main/SnapHutaoRemasteringProjectRootCA.cer)を **信頼されたルート証明機関** にダウンロードしてインストールしてください。
:::
...
- すべてのコンパイル記録は、[Alpha パイプライン](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered/actions/workflows/alpha.yml)で確認できます。
