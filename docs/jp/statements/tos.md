...
order: 4
description: Snap Hutao ユーザー利用規約および法的声明
...
- 十五、本"用户使用协议和法律声明"中，"我方"或称"本开发团队"（区别于"用户"或"您"）的实际主体为 [SnapHutaoRemasteringProject 开发团队](https://github.com/SnapHutaoRemasteringProject)的团队整体及每个成员个人，即包含前述网站中，[SnapHutaoRemasteringProject 开发团队](https://github.com/SnapHutaoRemasteringProject)的全部成员。
