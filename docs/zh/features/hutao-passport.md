...
## 云服务说明
::: tip 
DGP-Studio 团队旗下胡桃云已停止服务，已上传的账号数据将永久保存，但与 Remastered 团队托管服务器账号数据不互通。针对 DGP-Studio 服务器云数据，若有获取需要，请联系其团队成员以获得您的账号存档数据。对于云存档数据不同胡桃开发平台是兼容的，软件可以正常访问。其他任何疑问，您可以联系任何开发团队以处理。
:::
::: info
DGP-Studio 团队旗下胡桃云已停止服务，Remastered 团队为所有用户提供永久免费的云存档功能
:::
