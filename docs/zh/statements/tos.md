...
order: 4
description: Snap Hutao Remastered 的用户使用协议和法律声明。
...
- 本“用户使用协议和法律声明”（以下简称“条款”或“使用协议”）适用于 [SnapHutaoRemasteringProject 开发团队](https://github.com/SnapHutaoRemasteringProject)（以下简称“本团队”或“我方”）开发的全部软件作品、各开发项目的官方网站、附属的自媒体账号等。
  ...
  - SnapHutaoRemasteringProject 保留最终解释权。
  - Millennium Science Technology Research Development Institute 和 DGP-Studio 保留最终解释权。
...
- 三、一切因使用本团队所开发的任意项目的内容而导致的“任何意外损失（包括但不限于：软件、硬件、财产以及虚拟物品等）”、“合约毁坏”、“诽谤”、“版权或知识产权侵犯”及其所造成的损失与责任，均为使用者自身对于网络公开的开源软件的使用过程中自身发生的使用行为所引致的“损失与责任”，基于全部作品在其开放源代码的位置（即 [Github](https://github.com/SnapHutaoRemasteringProject) ）中所声明的 [MIT license](https://github.com/SnapHutaoRemasteringProject/Snap.Hutao.Remastered/blob/main/LICENSE) 以及本声明所约定的内容，应当认定前述的“损失与责任”与全部项目的有关开发者无责任关联。
...
- 八、所开发项目的著作权。
  ...
  - 使用本团队所开发的任意项目的过程中可能会产生拥有原有版权的数据，对于这些数据，本团队所开发的任意项目不拥有它们的所有权，为了避免造成侵权，使用者有义务完全阅读并履行“本使用协议第十条”的内容。本软件内使用的资源（包括但不限于字体、图片、文字等）均来源于互联网的公开信息，如果出现侵权可立即联系[我方](https://github.com/SnapHutaoRemasteringProject)移除。
  - Snap Hutao Remastered 客户端程序，以及 snaphutaorp.org 网站均与米哈游无关。
...
- 十二、本协议中的标题（包括副标题）仅为方便及阅读而设，并不影响本协议中任何规定的含义或解释。

- 十三、您和本开发团队均是独立的主体，在任何情况下本协议不构成本开发团队对用户的任何形式的明示或暗示担保或条件，双方之间亦不构成代理、合伙、合营或雇佣关系。

- 十四、本“用户使用协议和法律声明”中，“我方”或称“本开发团队”（区别于“用户”或“您”）的实际主体为 [SnapHutaoRemasteringProject 开发团队](https://github.com/SnapHutaoRemasteringProject)的团队整体及每个成员个人，即包含前述网站中，[SnapHutaoRemasteringProject 开发团队](https://github.com/SnapHutaoRemasteringProject)的全部成员。
