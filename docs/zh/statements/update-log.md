...
# 更新日志
## 2.1.0 Release<Badge text="最新版" type="tip" />
- 新增：
  - ✨优化了设置页面的布局
  - ✨优化了程序名称获取逻辑和显示
  - ✨优化了下载对话框的 UI 提示效果
  ...
  - ✨更改了任务栏图标左键逻辑，左键将永远打开主窗口
  - ✨为任务栏窗口添加关闭窗口隐藏按钮
  - ✨同步 v1.18.1 添加第三方工具功能，优化启动游戏界面速度
  - ✨添加了开源信息
  - ✨部分公告可以关闭提醒了
- 修复：
  - 🛠️修复下载对话框测试路径
...
- 新增：
  - ✨优化了自定义启动界面的 UI
  - ✨连带启动延迟启动程序功能上线，现在可以更方便地启动延迟启动程序了
  - ✨优化和提高了多处的多语言支持
- 修复：
  - 🛠️提高了部分场景下的稳定性
  - 🛠️同步 WDG 修复武器 ID
...
## 2.0.2.0 Release
- 新增：
  - ✨自定义启动上线，是的，现在可以自定义获取和快速下载启动任何你想要的但在胡桃内未实现的程序了
  - ✨延迟启动上线，你可以同时快捷启动其他程序
  - ✨优化和提高了多处的多语言支持
- 修复：
  - 🛠️修复了圣诞节无法结束的问题，现在在设置中可以自由切换
  - 🛠️提高了部分场景下的稳定性
  - 🛠️解决了以管理员权限运行偶现启动无反应和低UAC情况下无法启动的问题
- 已知问题：
  - ❔无法使用成就导入功能
  - ❔IP 检测服务未上线
  - ❔在部分语言下为未编写元数据做的回退机制不能隐藏默认的不可用角色，进入将导致不可恢复错误
...
**如需早于 2.0.0 版本的更新日志，请查阅 [`早于 2.0.0 版本的更新日志`](update-log-pre-2.0.0-archive.md) 一文**
