...
order: 7
comment: false
description: There are some third-party tools that can help you obtain the cookie from the miHoYo community with the Stoken field value and use it for Snap Hutao Remastered.
...
- Send the copied Stoken to the computer where the Snap Hutao Remastered is installed.
- In the Snap Hutao Remastered's account login section, click `Manual Input`.
