...
order: 6
comment: false
description: Snap Hutao Remastered provides Genshin Impact achievement management, allowing you to browse and manage the status of all achievements. Use the powerful filtering system to easily search for specific achievements.
---

# Achievement Management

Snap Hutao Remastered offers comprehensive Genshin Impact achievement management, allowing you to browse and manage the status of all achievements. Users can quickly locate achievements through various filtering methods, optimizing the management experience.
...
Snap Hutao Remastered supports various flexible achievement filtering methods:
...
Snap Hutao Remastered supports importing achievement data through the [UIAF Uniform Interchangeable Achievement Format](https://uigf.org/en/standards/uiaf.html).
...
::: tip
If you have multiple versions of Snap Hutao Remastered installed (such as the Alpha version and the official version), you need to change the default application for the `URL:hutao` link. You can find the `URL:hutao` entry in "Windows Settings - Apps - Default apps - Choose default apps by protocol" and click the icon to change it.
:::
