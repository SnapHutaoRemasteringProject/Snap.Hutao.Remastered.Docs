...
order: 8
comment: false
description: The "My Characters" feature in Snap Hutao Remastered can retrieve and display detailed data of the characters under a Genshin Impact account, including level, constellations, talents, and artifact attributes, and provide analysis.
---
